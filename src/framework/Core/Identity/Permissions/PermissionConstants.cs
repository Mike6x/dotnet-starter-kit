namespace FSH.Framework.Core.Identity.Permissions;
public static class PermissionConstants
{
    private static readonly List<FshPermission> _all = new()
    {
        ...
        new("View UserRoles", ActionConstants.View, ResourceConstants.UserRoles),
        ...
        new("View RoleClaims", ActionConstants.View, ResourceConstants.RoleClaims),
        ...
        // Hangfire / Dashboard
        new("View Hangfire", ActionConstants.View, ResourceConstants.Hangfire),
        new("View Dashboard", ActionConstants.View, ResourceConstants.Dashboard),
    };
